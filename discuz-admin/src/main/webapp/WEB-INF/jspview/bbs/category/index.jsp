...
<body >
                            ...
                            <div class="col-sm-12 b-r">
		                           ...
		                           <input name='id' type="hidden"/>
		                           	<table class='table table-bordered'>
		                           		<thead>
		                           		<tr style="text-align: center;" ><td colspan="6" ><h3>论坛分类管理</h3></td></tr>
		                           		</thead>
		                           		<tbody>
   ...
   <script>
    ...
    function submit_form(){
    	$.ajax({
    		   type: "POST",
    		   url:  $.common.getContextPath() + "/bbs/category/save",
    		   data: $("form").serialize(),
    ...
    function fun_delete(id){
    	...
    	layer.confirm('确定删除当前记录？', {
    		  btn: ['确定','取消'] //按钮
    			...
    			$.ajax({
    		 		   url:  $.common.getContextPath() + "/bbs/category/delete?id="+id,
    		 		   success: function(msg){
    		 		     if(msg.code==1){
    		 		    	 toastr.success('操作成功');
    ...
    $(document).ready(function(){
    	  ...
    	  $("#_new").click(function(){
        	...
        	table=$('#dt_table_view').DataTable( {
	            ...
	            "ajax": {
	                "url":  $.common.getContextPath() + "/bbs/category/list",
	                "type": "POST",
	                "dataSrc": "datas"
	              },
				"columns" : [{
