	                     ...
	                     <div class="col-sm-3">
	                        ...
	                        <div class="form-group">
	                           <div class="input-group ">
                                        ...
                                        <input type="text" placeholder="用户名" id="_name" class="form-control">
                                    </div>
							      </div>
	                            ...
	                            <button class="btn btn-primary" type="button" id='_new'><i class=" glyphicon glyphicon-pencil "></i>新增</button>
	                              <button class="btn btn-primary" type="button" id='_bathdelete'><i class="  glyphicon glyphicon-trash "></i>批量删除</button>
	                             <button class="btn btn-primary" onclick="fun_exportall()" type="button" id='btn_export'><i class="glyphicon glyphicon-export"></i>导出</button>
	                        </form>
											...
											<tr>
		                           		  ...
		                           		  <tr>
		                           			<td>是否禁言</td>
		                           				<td>
												  <label class='checkbox-inline'>
												    <input type="radio" name="gag"  value="false" checked>
												    	正常
												   </label>
												   <label class='checkbox-inline'>
												    <input type="radio" name="gag"  value="true">
												 	   禁言
												  </label>
		                           				</td>
		                           			</tr>
    	...
    	$.ajax({
 		   ...
 		   success: function(msg){
 		     if(msg.code==1){
 				...
 				//$("select[name='deptment.id']").val(msg.datas.deptment.id);
				 ...
				 "columnDefs": [
							   {
								...
								{
								    "render": function ( data, type, row ) {
								    	console.info(row.gag);
								        if(row.gag)
								        	return 	data+"<span class='label  label-danger'> 禁言中</span>";
								        	else
								        		return data;
