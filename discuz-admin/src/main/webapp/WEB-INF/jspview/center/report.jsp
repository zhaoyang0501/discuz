    ...
    <div class="wrapper wrapper-content animated fadeInRight">
        <div class="row">
            <div class="col-sm-3">
                <div class="ibox">
                    <div class="ibox-content">
                        <h5 class="m-b-md">今日发帖</h5>
                        <h2 class="text-navy">
                                    <i class="fa fa-play fa-rotate-270"></i> 4上升
                                </h2>
                        <small>更新时间：5分钟前</small>
                    </div>
                </div>
            </div>
            <div class="col-sm-3">
                <div class="ibox">
                    <div class="ibox-content ">
                        <h5 class="m-b-md">本月发帖</h5>
                        <h2 class="text-navy">
                                    <i class="fa fa-play fa-rotate-270"></i> 40上升
                                </h2>
                        <small>更新时间：5分钟前</small>
                    </div>
                </div>
            ...
            <div class="col-sm-3">
                <div class="ibox">
                    <div class="ibox-content">
                        <h5 class="m-b-md">今日回帖</h5>
                        <h2 class="text-danger">
                                    <i class="fa fa-play fa-rotate-90"></i>1 下降
                                </h2>
                        <small>更新时间：5分钟前</small>
                    </div>
                </div>
            ...
            <div class="col-sm-3">
                <div class="ibox">
                    <div class="ibox-content">
                        <h5 class="m-b-md">本月回帖</h5>
                        <h2 class="text-danger">
                                    <i class="fa fa-play fa-rotate-90"></i>10 下降
                                </h2>
                        <small>更新时间：5分钟前</small>
                    </div>
                </div>
