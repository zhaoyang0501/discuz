			...
			<div class="sidebar-collapse">
				<ul class="nav" id="side-menu">
					<li class="nav-header">
						...
						<li><a href="#"> <i class="fa fa-comments-o"></i> <span class="nav-label">论坛模块</span> <span class="fa arrow"></span>
						</a>
							<ul class="nav nav-second-level">
									<li><a class="J_menuItem" href="bbs/article/index">帖子管理</a></li>

									<li><a class="J_menuItem" href="bbs/create/index">发布帖子</a></li>
									<li><a class="J_menuItem" href="bbs/category/index">论坛版块</a></li>
									<li><a class="J_menuItem" href="sys/user/index">注册用户</a></li>
							</ul></li>
