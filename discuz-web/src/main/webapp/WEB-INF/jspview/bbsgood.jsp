			...
			<div class="aw-content-wrap clearfix">
				<div class="col-sm-12 col-md-9 aw-main-content">
					...
					<ul class="nav nav-tabs aw-nav-tabs active ">
						...
						<li><a href="${pageContext.request.contextPath}/bbshot">热门</a></li>
						<li  class="active"><a href="${pageContext.request.contextPath}/bbsgood">精华</a></li>
						...
						<div class="mod-body">
							<div class="aw-common-list">
								...
								<div class="aw-item active" data-topic-id="5,">
										<a class="aw-user-name hidden-xs" data-id="1325" href="#" rel="nofollow">
										<img src="http://wenda.ghostchina.com/uploads/avatar/000/00/13/25_avatar_max.jpg" alt=""></a>	<div class="aw-question-content">
														<h4>
