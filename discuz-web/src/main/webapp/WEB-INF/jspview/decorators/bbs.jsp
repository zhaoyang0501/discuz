...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/assets/css/common.css?v=7dddbe75bf" />
      <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/assets/js/simditor/simditor.css" />
...
<body class="home-template">
 ...
 <c:if test="${tip!=null }">
    	<div class="container text-center" style="padding-bottom: 2px">
