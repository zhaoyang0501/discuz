			...
			<div class="aw-content-wrap clearfix">
				<div class="col-sm-12 col-md-9 aw-main-content">
					...
					<ul class="nav nav-tabs aw-nav-tabs active ">
						...
						<li class="active"><a href="${pageContext.request.contextPath}/bbs">最新</a></li>
					...
					<div class="aw-mod aw-explore-list">
						<div class="mod-body">
							<div class="aw-common-list">
								...
								<c:forEach items="${newBbss }" var="bean">
				...
				<div class="col-sm-12 col-md-3 aw-side-bar hidden-xs hidden-sm">
					<div class="aw-mod aw-text-align-justify">
					 ...
					 <form action="${pageContext.request.contextPath}/bbssearch" method="post">
					  <div class="input-group" style="margin-bottom: 20px">
						    
						    
						     
						      <input name='key' type="text" class="form-control" placeholder="搜索帖子...">
